### EXPERIMENT.sql Documentation

This file documents the SQL statements in `EXPERIMENT.sql`, describing the schema, sample data, and query sets (EXP1–EXP6).
...
- **Q14. Display length of the string 'Abhay Kumar'**

  ```sql
  SELECT LENGTH('Abhay Kumar');
  ```
